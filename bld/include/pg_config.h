...
#define CONFIGURE_ARGS " '--prefix=/home/vldb/postgresql-16.2/bld' '--enable-debug'"
...
#define PG_VERSION_STR "PostgreSQL 16.2 on x86_64-pc-linux-gnu, compiled by gcc (Ubuntu 11.4.0-1ubuntu1~22.04) 11.4.0, 64-bit"
